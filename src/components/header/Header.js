    ...
    return (
        <div className="Header">
            <Navbar bg="white" expand="lg" className="pb-1 pt-0">
                ...
                <Navbar.Collapse id="basic-navbar-nav" className="col-lg-10 col-md-12 col-sm-12 pl-0 ml-0 pr-0 d-flex Header__navbar-flex-wrap justify-content-between">
                    <TabsContainer tabs={tabs} />
                    <Flex direction="row" wrap justifyContent="space-between" width="15%" UNSAFE_className="Header__responsive-box">
                        <Search aria-label="Search" UNSAFE_className="cursor-pointer" />
